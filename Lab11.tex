...
\hldef{plot.full.dat.error} \hlkwb{<-} \hldef{plot.full.dat} \hlopt{%>%}
  ...
  \hlkwd{filter}\hldef{(type} \hlopt{%in%} \hlkwd{c}\hldef{(}\hlsng{"Closer"}\hldef{,} \hlsng{"Farther"}\hldef{))} \hlcom{# Filter for Closer and Farther types}
...
\hldef{plot.full.dat} \hlkwb{<-} \hldef{plot.full.dat} \hlopt{%>%}
  \hlkwd{filter}\hldef{(type} \hlopt{%in%} \hlkwd{c}\hldef{(}\hlsng{"Closer"}\hldef{,} \hlsng{"Farther"}\hldef{))} \hlopt{%>%}
...
\hlkwd{ggplot}\hldef{(}\hlkwc{data} \hldef{= plot.full.dat)} \hlopt{+}
  ...
  \hlkwd{scale_y_continuous}\hldef{(}\hlkwc{breaks} \hldef{=} \hlkwd{round}\hldef{(}\hlkwd{seq}\hldef{(}\hlopt{-}\hlnum{0.60}\hldef{,} \hlnum{0.40}\hldef{,} \hlkwc{by} \hldef{=} \hlnum{0.20}\hldef{),} \hlnum{1}\hldef{))} \hlopt{+} \hlcom{# Set y-axis limits}
